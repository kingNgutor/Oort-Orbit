...
"""Implements IMU control with quaternion sensor fusion
and corrections for Godot/Android axes mismatch"""
...
func _physics_process(delta: float):
	...
	GlobalSignal.spaceship_orientation.emit(fused_quaternion) # emit quaternion rotations to singleton
