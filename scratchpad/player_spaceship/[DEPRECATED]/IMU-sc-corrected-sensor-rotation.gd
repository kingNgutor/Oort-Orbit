...
'''According to Google Gemini there is a better way to
resolve coordinate system mismatch...'''
...
func _physics_process(delta: float):
	...
	print("not corrected gyro = ", imu_gyro)
	get_corrected_sensor_input(imu_gyro)
	print("corrected gyro = ", imu_gyro)
	#imu_gyro = invert_Z(imu_gyro)
	imu_accelerometer = Input.get_accelerometer()
	get_corrected_sensor_input(imu_accelerometer) 
	#imu_accelerometer = invert_Z(imu_accelerometer)
	
	#print("gyro: ", imu_gyro)
	#print("acc: ", imu_accelerometer)
